  ...
  return (
    <header className='lg:w-1/2 sm:w-full w-full mb-4 mx-auto shadow-lg bg-white lg:p-2 p-1 rounded-xl'>
        <nav className='flex justify-between items-center w-full'>
            <Logo/>
            {location.pathname === '/' ? <Button className='gap-2 group'>
            ...
            :
            <Link to='/'>
                <Button className='flex items-center gap-2 group'><IoArrowBackSharp/><span className='lg:group-hover:scale-[1.5] text-xl transition-all duration-200'>🏠</span></Button>
                </Link>}
